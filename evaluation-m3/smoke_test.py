"""
Smoke test to verify that the M3-LLaVA model loader, prompt preprocessing,
...
def run_smoke_test() -> None:
    ...
    print("==========================================")
    print(" Running M3 VLM Calibration Smoke Test")
    print("==========================================")
