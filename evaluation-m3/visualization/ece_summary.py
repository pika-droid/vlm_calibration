"""
Summarize calibration metrics (ECE and MCE) across token depths for M3-LLaVA.
...
def generate_ece_summary(config: EvalConfig) -> None:
    ...
    ax1.set_title("Expected Calibration Error (ECE) across M3 Visual Token Scales")
    ...
    print("\n" + "=" * 50)
    print(" M3 VLM Calibration Summary (ECE & MCE)")
    print("=" * 50)
    ...
    with open(plots_dir / "calibration_metrics_table.md", "w") as f:
        f.write("# M3-LLaVA Calibration Metrics Summary Table\n\n")
