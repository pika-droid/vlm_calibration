"""
Visualization scripts to analyze prediction variance and stability for M3-LLaVA.
...
def plot_variance_example(
    ...
    plt.suptitle("M3-LLaVA Multi-Scale Prediction Stability Profile", fontsize=14, fontweight="bold")
    plt.tight_layout()
...
def generate_variance_plots(config: EvalConfig) -> None:
    ...
    plt.title("Distribution of M3 VQA Answer Stability across Token Scale Sweeps")
    ...
    plt.title("M3 VQA Model Performance and Softmax Confidence vs. Visual Token Scale")
    plt.tight_layout()
    ...
    with open(gallery_path, "w", encoding="utf-8") as f:
        f.write("# Prediction Variance & Stability Analysis Gallery (M3-LLaVA)\n\n")
